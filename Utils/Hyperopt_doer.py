...
class optParamAll(object):
    ...
    def objFunc(self, params):
        ...
        return {'loss': -np.mean(res), 'status': STATUS_OK, 'result1': np.mean(res)}
    ...
    def run(self):
        ...
        self.def_value = self.objFunc(default_value)['result1']
        ...
        inc_value = self.trails.best_trial['result1']['result1']
...
class optParamAdpt(object):
    ...
    def run(self):
        ...
        self.def_value = self.objFunc(adptdefault_value)['result1']
...
class optParamCLF(object):
    ...
    def run(self):
        ...
        self.def_value = self.objFunc(clfdefault_value)['result1']
